<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
    <div class="card bg-light-danger p-1 mx-1 mb-0" wire:offline>
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <p class="mb-0 ms-1">
                    YOU HAVEN'T INTERNET CONNECTION
                </p>
            </div>
        </div>
    </div>
    ...
    @foreach ($companies as $company)
        @if ($company->status)
            @hasrole('Super-Admin|Director|Operations-Manager')
                <li class="nav-item {{ Route::currentRouteName() === 'settings' ? 'active' : '' }}">
                    ...
                    <div class="card card-body py-0">
                        @if (isset($company->services))
                            ...
                            @forelse ($company->services as $service)
                                <li class="nav-item {{ Route::currentRouteName() === 'dashboard' ? 'active' : '' }}">
                                    <a href="{{ route('companies.services.plants.index', ['company' => $company->id, 'service' => $service->id]) }}"
    ...
    @hasrole('Super-Admin|Director|Administrative-Manager')
        <div class="mt-2 border mx-2"></div>
