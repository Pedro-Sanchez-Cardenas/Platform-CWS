            ...
            @forelse ($plants as $plant)
                <div wire:loading.remove wire:target='search' class="col-sm-12 col-md-6 col-lg-4">
                    <div class="card">
                        ...
                        @endhasanyrole
                        <img
                            src="https://www.f-w-s.com/assets/img/sistemas/planta_tratamiento_osmosis_inversa/planta-tratamiento-osmosis-inversa.jpg"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col text-center">
                                    <h4>{{ $plant->multimedia_filters_quantity }}
                                        <svg
                                ...
                                <div class="col text-center">
                                    <h4>{{ $plant->polish_filters_quantity }}
                                        <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="btn-group col-12" role="group">
                                <a href="{{ route('companies.services.plants.parameters.create', [$company, $service, $plant->id]) }}"
